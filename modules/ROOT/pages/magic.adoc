...
+
I'm not an average Word user. To me, Word is a powerful programmable document object model with a horrible user interface. Magic was fun and useful in its day, but I no longer use Word or maintain Magic. Writers today have better options at their disposal.
