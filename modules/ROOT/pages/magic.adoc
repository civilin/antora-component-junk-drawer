...
image:::magic_outputs.gif[title="Magic used layouts to customize HTML Help, web sites, and PDF files directly from Word--with no tweaking required to generate a different output"]
